function [V, T] = random_cube_101_shapes(nb_it, option_display)
%
% Author & support : nicolas.douillet (at) free.fr, 2017-2023.


% Importance des cubes internes ?
...
while p ~= nb_it
    ...
    for j = 1 : size(C,3)
        ...
        C_current = C(:,:,j);
        [V_new, F_new] = rand_split_cube(C_current);
...
if option_display          
    ...
    disp_random_cube_101_shapes(V,T,C);
    
end


end % random_cube_101_shapes


% Split cube subfunction
function [V_new, F_new] = rand_split_cube(C)
% Input
%
% C : cube structure
%
...
%          
%          
%          % Layer #3 (21/25 cubes) -> reste les 4 cubes milieux des diagonales
%          
%          73 74 80 79; % layer #3 top right corner cube
%          109 110 116 115;
%          73 79 115 109;
...
% Display subfunction
function [] = disp_random_cube_101_shapes(V, T, C)
%
...
end % disp_random_cube_101_shapes
