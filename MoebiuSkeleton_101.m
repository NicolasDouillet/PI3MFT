function [V, T, C] = MoebiuSkeleton_101(nb_it, option_display)
%
...
if option_display
    ...
    disp_MoebiuSkeleton_101(V,T,C);
    
end


end % MoebiuSkeleton_101
...
% Display subfunction
function [] = disp_MoebiuSkeleton_101(V, T, C)
