function [V, T] = large_granular_cube(nb_it, option_display)
%
...
if option_display          
    ...
    disp_large_granular_cube(V,T);
    
end


end % large_granular_cube
...
% Display subfunction
function [] = disp_large_granular_cube(V, T)
%
